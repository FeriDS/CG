...
class Example(Base):
    ...
    def initialize(self):
        ...
        # variable used to multiply the ambient lighting
        light_multiplier = 5;

        # four light sources
        ambient_light = AmbientLight(color=[light_multiplier * 0.1,light_multiplier * 0.1,light_multiplier * 0.1])
        ...
        flat_material = FlatMaterial(
            property_dict={"baseColor": [0.727, 0.0, 0.0]},
        ...
        phong_material = PhongMaterial(
            property_dict={"baseColor": [0.0, 0.0, 0.727]},
            number_of_light_sources=4
        )
        ...
        textured_flat_material = FlatMaterial(
            texture=Texture("images/sky.jpg"),
            number_of_light_sources=4
        )
