...
class Example(Base):
    ...
    def initialize(self):
        ...
        self.radios = 0.05
        position_data = circle(0.0, 0.0, self.radios, 100) 
        ...
        self.directionX = 1
        self.directionY = 1
        self.angle = random.uniform(0.0, 0.5) * math.pi
    ...
    def update(self):
        ...
        # self.angle = random.uniform(0.0, 0.5) * math.pi
        self.translation.data[0] += speed * math.cos(self.angle) * self.directionX
        self.translation.data[1] += speed * math.sin(self.angle) * self.directionY 

        if self.translation.data[0] < -1 + self.radios:
            self.translation.data[0] = -1 + self.radios
            self.directionX = 1
        ...
        if self.translation.data[1] < -1 + self.radios:
            self.translation.data[1] = -1 + self.radios
            self.directionY = 1
            self.angle = random.uniform(0.0, 2) * math.pi
